...
namespace MDR {
    ...
    public:
        ...
        void span_weight(){
            ...
            if (compressed_weights.size() != anonymous_extract_fixed_length_bits(compressed_weights.data(), block_weights.size(), reinterpret_cast<unsigned int*>(block_weights.data()), bit_count)){
